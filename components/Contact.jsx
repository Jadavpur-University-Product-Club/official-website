  ...
  return (
    <>
        <div class="flex flex-col items-center justify-center px-48">
            <div class="max-w-fit">                
                <p class="text-2xl font-bold text-center">Contact Us</p>
                <UnderLine />                
            </div>
            <form class="w-full mt-4" action="#" method="POST">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="college" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="tel" name="phone" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="phone" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Phone Number</label>
                </div>
                <div class="flex flex-col items-center justify-center px-48">        
                    <button class="rounded-full mb-6 bg-white text-black px-6 py-2">Connect Now</button>
                </div>        
            </form>
        </div>
    </>
