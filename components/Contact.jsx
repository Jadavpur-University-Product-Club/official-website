...
export default function Contact() {
  ...
  return (
    <section class="bg-website-background" id="contact_us">
      <div class="mx-auto max-w-screen-md px-4 py-8 lg:py-16">
        <h2 class="mb-4 text-center text-4xl font-extrabold tracking-tight text-white">
          Contact Us
        </h2>
        <p class="mb-8 text-center font-light text-gray-400 sm:text-xl lg:mb-16">
          Need details about our club ? Let us know.
        </p>
        <form action="#" class="space-y-8" onSubmit={submitForm}>
          <div>
            <label
              for="email"
              class="mb-2 block text-sm font-medium text-gray-50"
            >
              Your email
            </label>
            <input
          ...
          <div>
            <label
              for="subject"
              class="font-medium text-gray-50 mb-2 block text-sm"
            >
              Subject
            </label>
            <input
          ...
          <button
            type="submit"
            class="rounded-lg bg-gray-50 px-5 py-3 text-center text-sm font-medium text-black hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-amber-400 sm:w-fit"
          >
            Send message
          </button>
        </form>
