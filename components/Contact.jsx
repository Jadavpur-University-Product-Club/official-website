  ...
  return (
    <>
        <div className="flex flex-col items-center justify-center px-48">
            ...
            <form className="w-full mt-4" action="#" method="POST">
                ...
                <div className="relative z-0 w-full mb-6 group">
                    <input type="text" name="college" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-6 group">
                    <input type="tel" name="phone" id="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div className="flex flex-col items-center justify-center px-48">        
                    <button className="rounded-full mb-6 bg-white text-black px-6 py-2">Connect Now</button>
                </div>        
            </form>
        </div>
    </>
