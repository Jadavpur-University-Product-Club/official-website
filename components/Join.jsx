      ...
      <div className='flex flex-col items-center py-8'>
        <div className="flex flex-col items-center justify-center w-3/6">
            <div className="max-w-fit">                
                <p className="text-4xl font-bold text-center font-montserrat">Join Us</p>
                <UnderLine />                
            </div>
        ...
        <button className="rounded-full my-4 bg-white hover:border-line-color-2 border-4 border-transparent text-black px-16 py-3 text-base font-semibold font-open-sans uppercase">Join Now</button>
      </div>
    </>
  )
}
